...
public class PermissionHelper {
     ...
     * @return
     */
    public static List<EcustPermission> bulid(List<EcustPermission> treeNodes) {
     ...
     * @return
     */
    public static EcustPermission findChildren(EcustPermission treeNode,List<EcustPermission> treeNodes) {
